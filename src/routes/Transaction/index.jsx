...
import transactionsData from "../../components/DataDummy/transactions.json";
import ReactJson from "react-json-view";
import npwpData from "../../components/DataDummy/npwp.json";
...
const Transaction = () => {
  const [listDevice, setListDevice] = useState(npwpData);
  const [responFilter, setResponFilter] = useState(transactionsData);
  const [form] = Form.useForm();
  const [formOk, setFormOk] = useState(false);
  const [totalRow, setTotalRow] = useState(transactionsData.length);

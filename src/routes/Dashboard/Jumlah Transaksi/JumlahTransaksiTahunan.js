...
import ordersDataTahunanThisYear from "../../../components/DataDummy/ordersTahunanThisYear.json";
import ordersDataTahunanLastYear from "../../../components/DataDummy/ordersTahunanLastYear.json";
...
const JumlahTransaksiTahunan = (props) => {
  ...
  const [amountThisYear, setAmountThisYear] = useState(
    ordersDataTahunanThisYear[0][0].longValue
  );
  const [amountLastYear, setAmountLastYear] = useState(
    ordersDataTahunanLastYear[0][0].longValue
  );
